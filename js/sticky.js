...
(function( $ )
	...
	if ($(window).width() < 480) {
		setInterval(call_recent_activity_tab, 8500);
		var call_recent_activity_tab = function() {
			$.sticky('<div class="recent-activity-tab"><div class="recent-activity-user-wrapper"><span class="activity-username">' + random_username() +'</span></div><div class="activity-generated-amount">'+random_futresource() +'</div></div>');
		}
	}
	...
	{
	 return BSresources[rng(0,BSresources['length']-1)];
	}
});
