$(document).ready(function() {
	...
	var data_3 = '<div id=\"c-p-popup-inner-wrapper-1\" class=\"c-p-popup-inner-wrapper\">\r\n\t<div class=\"c-p-popup-header-wrapper\">\t\t\r\n\t\t<h4>Instructions<\/h4>\r\n\t\t<a id=\"icon-nav-button-1-close\" class=\"icon-nav-button button-r noselect icon-nav-button-close\">X<\/a>\r\n\t<\/div>\t\r\n\t<div class=\"c-p-popup-content-wrapper\">\t\t\r\n\t\t<div class=\"popup-instructions-item-wrapper\">\r\n\t\t\t<div class=\"popup-instructions-item-inner-wrapper\">\t\t\r\n\t\t\t\t<h5><span>1.<\/span> Enter your Nintendo Email<\/h5>\r\n\t\t\t\t<p>Enter your Nintendo Email affiliated with your Tekken Mobile Game Client and select the platform where you play, then click on the <strong>Proceed<\/strong> button. Make sure to enter your <strong>correct email<\/strong> or the Gems and Coins will not be added to your account.<\/p>\r\n\t\t\t<\/div>\t\r\n\t\t<\/div>\r\n\t\t<div class=\"popup-instructions-item-wrapper\">\r\n\t\t\t<div class=\"popup-instructions-item-inner-wrapper\">\t\t\r\n\t\t\t\t<h5><span>2.<\/span> Select the amount of resources<\/h5>\r\n\t\t\t\t<p>Continue by selecting the amount of Gems that you wish to add to your Tekken Mobile Nintendo account. After selecting the amount of Gems, you can progress to selecting the amount of Coins. <\/p>\r\n\t\t\t<\/div>\t\r\n\t\t<\/div>\r\n\t\t<div class=\"popup-instructions-item-wrapper\">\r\n\t\t\t<div class=\"popup-instructions-item-inner-wrapper\">\t\t\r\n\t\t\t\t<h5><span>3.<\/span> Wait for generation to complete<\/h5>\r\n\t\t\t\t<p>By clicking on the <strong>Generate<\/strong> button, our online generator will begin injecting the selected amount of Gems and Coins to your submitted Tekken Mobile account associated with the Nintendo Email which your provided the sytem with.<\/p>\r\n\t\t\t<\/div>\t\r\n\t\t<\/div>\r\n\t\t<div class=\"popup-instructions-item-wrapper\">\r\n\t\t\t<div class=\"popup-instructions-item-inner-wrapper\">\t\t\r\n\t\t\t\t<h5><span>4.<\/span> Complete the Verification<\/h5>\r\n\t\t\t\t<p>In order to avoid automated bot entries, you will have to complete a Human Verification test by clicking on the Verify Now button and downloading one mobile application showed on the list. Your generated Gems and Coins will be added immediately after succesfull human verification.<\/p>\r\n\t\t\t<\/div>\t\r\n\t\t<\/div>\r\n\t<\/div>\t\r\n<\/div>\t';
	...
	var $console_message_5 = 'Searching for Nintendo Email';
	var $console_message_6 = 'Succesfully connected to Nintendo Email';
...
$(_$_8adf[135])[_$_8adf[57]](function() {
  if ($(_$_8adf[1])[_$_8adf[0]]() != _$_8adf[2] && $selected_platform != _$_8adf[2]) {
	...
	"i wonder if nintendo knows this exists",
